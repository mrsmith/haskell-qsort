...
run: build test-data
	...
	@echo
	@echo "=== SORTED DATA ==="
	@./run_benchmark.sh c_benchmark sorted
	@./run_benchmark.sh haskell_benchmark sorted
	@echo
	@echo "=== REVERSE SORTED DATA ==="
	@./run_benchmark.sh c_benchmark reverse
	@./run_benchmark.sh haskell_benchmark reverse
	@echo
	@echo "=== DUPLICATE-HEAVY DATA ==="
	@./run_benchmark.sh c_benchmark duplicates
	@./run_benchmark.sh haskell_benchmark duplicates

clean:
	rm -f c_benchmark haskell_benchmark *.hi *.o
	rm -rf data